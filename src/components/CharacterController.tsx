  ...
  return (
    <RigidBody colliders={false} lockRotations ref={rb}>
      <group ref={container}>
        ...
        <group ref={cameraPosition} position-y={10} position-z={-4} />
        <group ref={character}>
          <Character color="white" position={[0, .38, 0]} animation={animation} />
        </group>
      </group>
      <CapsuleCollider args={[0.53, 0.38]} position={[0, 1.28, 0]} />
    </RigidBody>
  )
}